# The current code replaces all missing values for op_any as ==0
# Code starts
...
copd$op_any[copd$op_any==7|copd$op_any==9]<-2 # re-coding missing data
...
write.csv(copd, "copd_na_equals_two.csv")
